        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            <form method="POST"  action="{{ route('employee.store')}}" aria-label="{{ __('Login') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                    <label for="company_id" class="col-sm-4 col-form-label text-md-right">Photo</label>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="name" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" >
